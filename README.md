...
访问 [`index.html`](index.html) 查看各地区测试报告概览！

目前支持的地区：
- 🇨🇳 [中国地区测试报告](mullvad-speed-test-cn.html)
- 🇭🇰 [香港地区测试报告](mullvad-speed-test-hk.html)
- 🇺🇸 [美国地区测试报告](mullvad-speed-test-us.html)
...
1. 显示测试进度（百分比）
2. 生成 HTML 报告文件，根据地区参数生成不同的文件名：
   - 中国地区：`mullvad-speed-test-cn.html`
   - 香港地区：`mullvad-speed-test-hk.html`
   - 美国地区：`mullvad-speed-test-us.html`
3. 在控制台显示最快的 10 个节点
